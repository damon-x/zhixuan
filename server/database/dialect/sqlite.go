// Package dialect is a vendored gorm SQLite dialector that targets
// modernc.org/sqlite (pure Go, no CGO). It is functionally identical to
// github.com/glebarez/sqlite except it uses the SAME modernc.org/sqlite driver
// that the rest of the project (sqvect) already imports, so the "sqlite"
// database/sql driver is registered exactly once.
package dialect
