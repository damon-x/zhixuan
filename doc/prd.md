...
向量模型：
user@host %
user@host % curl --location 'https://dashscope.aliyuncs.com/compatible-mode/v1/embeddings' \
...
~/your/project/path/listen_qqbot_messages.py
给 qq 用户发送消息
~/your/project/path/send_msg.py
...
参考代码
``` bash
~/your/project/path/weixin_text_echo.go
~/your/project/path/weixin_text_echo.py
~/your/project/path/WEIXIN_ILINK_PROTOCOL.zh_CN.md（文档较大，谨慎加载）
```
绑定流程：
...
``` bash
claude-code 实现：
Read: ~/your/project/path/claude-code/src/tools/FileReadTool/FileReadTool.ts
Write: ~/your/project/path/claude-code/src/tools/FileWriteTool/FileWriteTool.ts
Edit: ~/your/project/path/claude-code/src/tools/FileEditTool/FileEditTool.ts
NotebookEdit: ~/your/project/path/claude-code/src/tools/NotebookEditTool/NotebookEditTool.ts

openclaw 实现：
 ~/your/project/path/openclaw-main/src/agents/sessions/tools/read.ts
 ~/your/project/path/openclaw-main/src/agents/sessions/tools/write.ts
~/your/project/path/openclaw-main/src/agents/sessions/tools/edit.ts
~/your/project/path/openclaw-main/src/agents/sessions/tools/path-utils.ts
~/your/project/path/openclaw-main/src/agents/sessions/tools/file-mutation-queue.ts
~/your/project/path/openclaw-main/src/agents/sessions/tools/edit-diff.ts
~/your/project/path/openclaw-main/packages/agent-core/src/harness/utils/truncate.ts
```

获取目录下文件列表的tool,的参考代码
```bash
claude-code 实现：
~/your/project/path/claude-code/src/tools/GlobTool/GlobTool.ts
~/your/project/path/claude-code/src/utils/glob.ts
~/your/project/path/claude-code/src/tools/BashTool/BashTool.tsx
~/your/project/path/claude-code/src/tools/FileReadTool/prompt.ts

openclaw 实现：
~/your/project/path/openclaw-main/src/agents/sessions/tools/ls.ts
~/your/project/path/openclaw-main/src/agents/sessions/tools/find.ts
~/your/project/path/openclaw-main/src/agents/sessions/tools/grep.ts
```
...
```bash
# qqbot 发送和接收图片的代码参考：
~/your/project/path/openclaw-qqbot-main/QQ_IMAGE_API.md
```
